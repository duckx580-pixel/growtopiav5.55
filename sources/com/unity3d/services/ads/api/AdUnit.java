                ...
                if (rootWindowInsets != null) {
                    ...
                    try {
                        ...
                        if (objInvoke != null) {
                            ...
                            jSONObject.put(TJAdUnitConstants.String.TOP, objInvoke2);
                            jSONObject.put(TJAdUnitConstants.String.RIGHT, objInvoke3);
                            jSONObject.put(TJAdUnitConstants.String.BOTTOM, objInvoke4);
                            jSONObject.put(TJAdUnitConstants.String.LEFT, objInvoke5);
                            webViewCallback.invoke(jSONObject);
                        } else {
