...
public class WebPlayerView extends WebView {
    ...
    public <T> T getReturnValue(String str, Class<T> cls, T t) {
        try {
            JSONObject jSONObject = this._eventSettings;
            return (jSONObject != null && jSONObject.has(str) && this._eventSettings.getJSONObject(str).has("returnValue")) ? cls.cast(this._eventSettings.getJSONObject(str).get("returnValue")) : t;
        } catch (Exception e) {
    ...
    private class WebPlayerClient extends WebViewClient {
        ...
        public void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
            ...
            if (WebPlayerView.this.shouldSendEvent("onReceivedError")) {
                ...
                WebPlayerEventBridge.error(WebPlayerView.this.viewId, string2, string);
            }
        }
        ...
        public void onReceivedHttpError(WebView webView, WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
            ...
            if (WebPlayerView.this.shouldSendEvent("onReceivedHttpError")) {
                ...
                WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.WEBPLAYER, WebPlayerEvent.HTTP_ERROR, string, str, Integer.valueOf(i), WebPlayerView.this.viewId);
            }
        }
    ...
    private class WebPlayerChromeClient extends WebChromeClient {
        ...
        public void onPermissionRequest(PermissionRequest permissionRequest) {
            ...
            if (WebPlayerView.this.shouldSendEvent("onPermissionRequest")) {
                ...
                WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.WEBPLAYER, WebPlayerEvent.PERMISSION_REQUEST, string, WebPlayerView.this.viewId);
            }
        }
        ...
        public boolean onJsPrompt(WebView webView, String str, String str2, String str3, JsPromptResult jsPromptResult) {
            ...
            if (WebPlayerView.this.shouldCallSuper("onJsPrompt")) {
                ...
                boolValueOf = Boolean.valueOf(zOnJsPrompt);
            } else {
                str4 = str3;
                str5 = str2;
                str6 = str;
        ...
        public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
            ...
            if (WebPlayerView.this.shouldSendEvent("onConsoleMessage")) {
                ...
                WebViewApp.getCurrentApp().sendEvent(WebViewEventCategory.WEBPLAYER, WebPlayerEvent.CONSOLE_MESSAGE, strMessage, WebPlayerView.this.viewId);
            }
