...
public final class C3 {
    ...
    public static void A02() {
        A07 = new byte[]{87, 67, 82, 95, 89, Ascii.EM, 91, 70, 83, 81, Ascii.CAN, Ascii.FF, Ascii.GS, Ascii.DLE, Ascii.SYN, 86, Ascii.DC4, 9, Ascii.FS, Ascii.RS, 84, 53, 72, 66, 86, 71, 74, 76, Ascii.FF, 78, 83, 70, 68, Ascii.SO, 111, 17};
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static boolean A04(int i, C3 c3) {
        int i2;
        int i3;
        int i4;
        int i5;
            ...
            if (A08[4].length() == 11) {
                ...
                if (i8 == 3) {
                    ...
                    if (i7 == 3) {
                        ...
                        i4 = A0C[i2 - 1];
                        i5 = i8 == 1 ? 576 : 1152;
                        i6 = (((i8 == 1 ? 72000 : 144000) * i4) / i9) + i11;
                    }
                }
                c3.A03(i7, A0F[3 - i8], i6, i9, ((i >> 6) & 3) == 3 ? 1 : 2, i4 * 1000, i5);
                return true;
            }
        }
        throw new RuntimeException();
    ...
    static {
        ...
        A09 = new int[]{32, 64, 96, 128, 160, 192, 224, 256, 288, Sdk.SDKError.Reason.WEBVIEW_ERROR_VALUE, 352, 384, 416, 448};
        A0D = new int[]{32, 48, 56, 64, 80, 96, 112, 128, 144, 160, 176, 192, 224, 256};
        A0A = new int[]{32, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, Sdk.SDKError.Reason.WEBVIEW_ERROR_VALUE, 384};
        A0B = new int[]{32, 40, 48, 56, 64, 80, 96, 112, 128, 160, 192, 224, 256, Sdk.SDKError.Reason.WEBVIEW_ERROR_VALUE};
