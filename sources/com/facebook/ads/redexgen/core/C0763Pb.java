...
public final class C0763Pb {
    ...
    public PQ A02;
    public PZ A03;
    public InterfaceC0762Pa A04;
    public C0824Rk A05;
    public final int A08;
    public final AbstractC1178cD A09;
    public final C03136f A0A;
    public final C1036Zs A0B;
    public final J7 A0C;
    public final JF A0D;
    public final PO A0E;
    public final UA A0F;
    public final C0774Pm A0G;
    public final C0775Pn A0H;
    public final LinkedList<PY> A0J = new LinkedList<>();
    public C0679Lv A01 = new C0679Lv();
    ...
    public final void A0i(Map<String, String> map) {
        ...
        if (map.containsKey(strA0A) && C0599Im.A1q(this.A0B)) {
            try {
                ...
                String strA04 = T4.A04(arrayList);
                HashMap map2 = new HashMap();
                map2.put(A0A(115, 6, 126), strA04);
                if (strA04 != null) {
                    this.A0C.AAR(this.A09.A1U(), map2);
                }
            } catch (Exception e) {
    ...
    public C0763Pb(C1036Zs c1036Zs, AbstractC1178cD abstractC1178cD, J7 j7, int i) {
        this.A0B = c1036Zs;
        this.A0C = j7;
        this.A09 = abstractC1178cD;
        this.A08 = i;
        this.A0F = new UA(this, c1036Zs);
        this.A0A = new C03136f(this.A0B);
        this.A0D = new JF(abstractC1178cD.A1U(), j7);
        this.A0E = new PO(abstractC1178cD.A0l(), abstractC1178cD.A1P().A0E().A08(), i);
        this.A0H = AbstractC0776Po.A00(this.A0B, abstractC1178cD.A0o(), this.A0A, this.A0D, this.A0E, A0H());
        this.A0G = new C0774Pm(this.A0B, this, j7, this.A0E, this.A0I, abstractC1178cD.A1U());
    }
    ...
    private void A0C() {
        ...
        A0F(new PY(A0A(310, 26, 76), new String[]{strReplace, assets}));
    }
    ...
    public synchronized void A0E() {
        if (this.A06) {
            while (!this.A0J.isEmpty()) {
                PY pyPoll = this.A0J.poll();
                if (pyPoll != null) {
                    this.A0F.A05(String.format(Locale.US, pyPoll.A00, pyPoll.A02));
                    if (pyPoll.A01) {
                        this.A0D.A04(JE.A0L, null);
                        this.A0B.A0E().A5c(pyPoll.A00);
                    }
                }
            }
        }
    ...
    private boolean A0I() {
        return C0599Im.A2n(this.A0B, RS.A03());
    }
    ...
    public final void A0U() {
        A0F(new PY(A0A(168, 27, 109), new String[]{this.A0I}));
    }
    ...
    public final void A0X() {
        ...
        try {
            ...
            jSONObject.put(url2, AbstractC0764Pc.A00());
    ...
    public final void A0Z(C0679Lv c0679Lv) {
        this.A01 = c0679Lv;
    }
    ...
    public final void A0c(InterfaceC0762Pa interfaceC0762Pa) {
        this.A04 = interfaceC0762Pa;
    }
    ...
    public final void A0e(C0824Rk c0824Rk) {
        this.A05 = c0824Rk;
    }
