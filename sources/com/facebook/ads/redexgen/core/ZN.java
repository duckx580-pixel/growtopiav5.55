...
public final class ZN implements InterfaceC03638p {
     ...
     */
    public final String A04(InterfaceC03618n interfaceC03618n) {
        C03598l.A08(this.A01, true, null);
        ...
        try {
            try {
                ...
                mapA05.put(A01(278, 4, 25), C6H.A00().A03());
                mapA05.put(A01(554, 10, 101), AbstractC03678t.A06(new C8O(this.A01), this.A01, false));
                if (C0599Im.A1r(this.A01)) {
                    mapA05.put(A01(101, 10, 16), C01760w.A01(this.A01).A0K());
                }
                Iterator it = mapA05.entrySet().iterator();
                while (it.hasNext()) {
                    if (!interfaceC03618n.A2w((String) ((Map.Entry) it.next()).getKey())) {
                        it.remove();
                    }
                }
    ...
    public final /* synthetic */ Map A05() {
        return AbstractC03608m.A00(this);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:111:0x0402 A[EDGE_INSN: B:111:0x0402->B:70:0x0402 BREAK  A[LOOP:0: B:57:0x0396->B:62:0x03b5], SYNTHETIC] */
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC03638p
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.util.Map<java.lang.String, java.lang.String> A7K(com.facebook.ads.redexgen.core.InterfaceC03518d r12) {
        /*
            Method dump skipped, instruction units count: 1366
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.ZN.A7K(com.facebook.ads.redexgen.X.8d):java.util.Map");
    }
    ...
    public ZN(C7j c7j, boolean z, C6V c6v) {
        this.A01 = c7j;
        this.A00 = c6v;
        C03598l.A08(c7j, z, null);
    }

    public static synchronized PackageInfo A00(C7j c7j) {
        if (!A03) {
            A02 = AbstractC0658La.A00(c7j);
            A03 = true;
        }
        return A02;
    }
