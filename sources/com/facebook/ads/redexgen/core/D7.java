...
public final class D7 {
    ...
    public final SparseArray<C0587Hz> A0D = new SparseArray<>();
    public final SparseArray<C0586Hy> A0C = new SparseArray<>();
                ...
                if (this.A0F.A09()) {
                    ...
                    if (this.A0F.A09()) {
                        ...
                        if (this.A0F.A09()) {
                            ...
                            C0586Hy c0586Hy = this.A0C.get(iA042);
                            C0587Hz c0587Hz = this.A0D.get(c0586Hy.A01);
                            if (A0I[1].length() == 29) {
                                A0I[1] = "jUrYfFWx4oU0PZ0BHu9RO88HJSHdN";
                                C0587Hz c0587Hz2 = c0587Hz;
                                if (c0587Hz2.A09) {
                                    if (!this.A0F.A0B(2)) {
                                        return;
                                    } else {
                                ...
                                if (!this.A0F.A0B(c0587Hz2.A01)) {
                                    return;
                                }
                                boolean zA0A = false;
                                boolean z = false;
                                boolean zA0A2 = false;
                                int iA052 = this.A0F.A05(c0587Hz2.A01);
                                if (!c0587Hz2.A08) {
                                    if (!this.A0F.A0B(1)) {
                                        return;
                                    }
                                ...
                                if (A0I[3].charAt(28) != 'b') {
                                    ...
                                    int iA033 = 0;
                                    if (c0587Hz2.A04 == 0) {
                                        if (!this.A0F.A0B(c0587Hz2.A03)) {
                                            return;
                                        }
                                        iA053 = this.A0F.A05(c0587Hz2.A03);
                                        if (c0586Hy.A02 && !zA0A) {
                                            if (!this.A0F.A09()) {
                                                return;
                                            } else {
                                    ...
                                    } else if (c0587Hz2.A04 == 1 && !c0587Hz2.A07) {
                                        if (!this.A0F.A09()) {
                                            return;
                                        }
                                        iA032 = this.A0F.A03();
                                    ...
                                    this.A07.A04(c0587Hz2, iA05, iA04, iA052, iA042, zA0A, z, zA0A2, z2, iA043, iA053, iA03, iA032, iA033);
                                    this.A08 = false;
                                    return;
                                }
                            }
    ...
    public D7(C9 c9, boolean z, boolean z2) {
        this.A0E = c9;
        this.A0G = z;
        this.A0H = z2;
        A01();
    ...
    */
    public final void A02(long r8, int r10) {
        /*
            ...
            boolean r0 = com.facebook.ads.redexgen.core.D6.A01(r1, r0)
            if (r0 == 0) goto L2e
        L16:
            boolean r0 = r7.A09
            if (r0 == 0) goto L22
        ...
        L2e:
            ...
            if (r1 == r0) goto L61
            boolean r6 = r7.A0G
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.D7.A0I
            r0 = 6
            r1 = r1[r0]
            r0 = 8
            ...
            throw r0
        L4c:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.D7.A0I
        ...
        L62:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.D7.A02(long, int):void");
    }
    ...
    */
    public final void A03(long r7, int r9, long r10) {
        ...
        L6f:
            ...
            goto L53
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.D7.A03(long, int, long):void");
    }

    public final void A04(C0586Hy c0586Hy) {
        this.A0C.append(c0586Hy.A00, c0586Hy);
    }

    public final void A05(C0587Hz c0587Hz) {
        this.A0D.append(c0587Hz.A05, c0587Hz);
    }
