...
public final class ViewpointRegistry {
    ...
    public final Map<DspViewableNode, Map<C1267dt, Cdo<?, ?>>> A01;
    ...
    public static void A01() {
        A03 = new byte[]{-18, -10, -7, -3, 2, -98, -96, -79, -90, -84, -85, -94, -100, -80, -16, -15, -26, -25, Ascii.DLE, 4, -30, Ascii.SO, Ascii.CR, 5, 8, 6, -13, -26, -12, -10, -19, -11, -49, -62, -66, -48, -55, -56, -62, -57, -51, -99, -70, -51, -70};
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized void A05(DspViewableNode dspViewableNode, C1267dt c1267dt, Cdo<?, ?> cdo) {
        C1234d7.A07(dspViewableNode, A00(14, 4, 83));
        C1234d7.A07(c1267dt, A00(11, 3, 8));
        C1234d7.A07(cdo, A00(32, 13, 42));
        Map<DspViewableNode, Map<C1267dt, Cdo<?, ?>>> map = this.A01;
        WeakHashMap weakHashMap = map.get(dspViewableNode);
        if (weakHashMap == null) {
            weakHashMap = new WeakHashMap();
            map.put(dspViewableNode, weakHashMap);
        }
        weakHashMap.put(c1267dt, cdo);
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized void A07(DspViewableNode dspViewableNode, InterfaceC0565Hd<? super Cdo<?, ?>, C1243dK> interfaceC0565Hd) {
        Collection<Cdo<?, ?>> collectionValues;
        C1234d7.A07(dspViewableNode, A00(14, 4, 83));
        C1234d7.A07(interfaceC0565Hd, A00(5, 6, 14));
        Cdo<?, ?> cdo = this.A02.get(dspViewableNode);
        if (cdo != null) {
            interfaceC0565Hd.A9K(cdo);
        }
        Map<C1267dt, Cdo<?, ?>> map = this.A01.get(dspViewableNode);
        if (map != null && (collectionValues = map.values()) != null) {
            Iterator<T> it = collectionValues.iterator();
            while (it.hasNext()) {
                interfaceC0565Hd.A9K((Cdo) it.next());
            }
        }
    }
    ...
    public final synchronized void A08(Collection<DspViewableNode> collection) {
        C1234d7.A07(collection, A00(26, 6, 82));
    ...
    public ViewpointRegistry(ViewpointQeConfig viewpointQeConfig) {
        C1234d7.A07(viewpointQeConfig, A00(18, 8, 112));
    ...
    public final synchronized void A04(DspViewableNode dspViewableNode, C1267dt c1267dt) {
        C1234d7.A07(dspViewableNode, A00(14, 4, 83));
        C1234d7.A07(c1267dt, A00(11, 3, 8));
        Map<C1267dt, Cdo<?, ?>> map = this.A01.get(dspViewableNode);
        if (map != null) {
