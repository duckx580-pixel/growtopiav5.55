...
public abstract class AbstractC1236d9 {
    ...
    public static final Object[] A02(Collection<?> collection) {
        C1234d7.A07(collection, A00(0, 10, 17));
        ...
        while (true) {
            ...
            if (i2 >= length) {
                ...
                C1234d7.A06(objArrCopyOf, strA00);
                i = i2;
            } else {
                if (!it.hasNext()) {
                    Object[] objArrCopyOf2 = Arrays.copyOf(objArrCopyOf, i2);
                    C1234d7.A06(objArrCopyOf2, strA00);
                ...
                if (!it.hasNext()) {
                    ...
                    if (size$iv != $i$f$toArrayImpl2) {
                        ...
                        if (size <= length) {
                            ...
                            C1234d7.A05(objNewInstance, A00(21, 62, 11));
